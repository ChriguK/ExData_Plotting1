############################################################################
#
# This R script produces plot 4 of assignment 1 of the course
...
# Create plot 4 and save it in a png file

png("plot4.png")
par(mfrow=c(2,2))
    plot(hpc.time, hpc.data$Global_active_power, type='l', 
        xlab = "",
        ylab = "Global Active Power (kilowatts)")

    plot(hpc.time, hpc.data$Voltage, type='l', 
        xlab = "datetime",
        ylab = "Voltage")
    ...
    plot(hpc.time, hpc.data$Global_reactive_power, type='l', 
        xlab = "datetime",
